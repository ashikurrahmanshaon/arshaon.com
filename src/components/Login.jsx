...
const Login = () => {
  ...
  const handleSocialLogin = async (providerName, providerFn) => {
  ...
  return (
    <div className="flex-grow flex items-center justify-center pt-32 pb-20 px-6 relative z-10 w-full">
      <motion.div 
        ...
        className="max-w-md w-full bg-gradient-to-b from-white/[0.05] to-black/40 border border-white/[0.08] p-6 md:p-8 rounded-3xl backdrop-blur-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden ring-1 ring-white/[0.02]"
      >
        {/* Top Highlight Line */}
        ...
        <div className="relative z-10 text-center mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-display font-bold text-white mb-2 uppercase tracking-wide">Welcome Back</h1>
          <p className="text-gray-400 text-sm">Log in to your account to manage your projects.</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-white/[0.03] border border-white/[0.05] rounded-xl py-3 pl-10 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:border-primary/50 focus:bg-primary/[0.02] focus:ring-1 focus:ring-primary/50 transition-all text-sm shadow-inner"
              />
            </div>
          </div>
        ...
        <div className="relative z-10 text-center mt-6">
           <p className="text-gray-400 text-sm">
             Don't have an account? <Link to="/signup" className="text-primary font-bold hover:text-white transition-colors">Sign up</Link>
           </p>
        </div>
